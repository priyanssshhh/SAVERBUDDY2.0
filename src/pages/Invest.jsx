...
export default function Invest() {
  ...
  return (
    <div className="finance-page">
      ...
      <p className="subtitle">AI-powered SIP, stock & savings recommendations based on your real finances</p>
        ...
        <>
          ...
          <div className="card">
            ...
            <div className="transaction-row">
              ...
              <span style={{ color: "#ff6b6b" }}>₹{totalExpenses}</span>
            </div>
            <div className="transaction-row">
          ...
          {result && (
            <>
              <div className="card" style={{ borderColor: "#00ffc8" }}>
                ...
                {result.emergencyFund && (
                  <p style={{ color: "#aaa", marginTop: 10, fontSize: "0.9rem" }}>
                    🛡️ Emergency Fund: {result.emergencyFund}
                  </p>
                )}
              </div>
              ...
              {result.recommendations?.map((rec, i) => (
                <div key={i} className="card">
                  ...
                  <div className="transaction-row" style={{ marginTop: 12 }}>
                    ...
                    <span style={{ color: "#00ffc8", fontWeight: "bold" }}>₹{rec.amount}</span>
                  </div>
                  <div className="transaction-row">
                  ...
                  <p style={{ color: "#aaa", fontSize: "0.88rem", marginTop: 10 }}>
                    💡 {rec.reason}
                  </p>
                </div>
              ))}
              ...
              {result.warnings?.length > 0 && (
                <div className="card" style={{ borderColor: "#ff4d4d" }}>
                  <h2 style={{ color: "#ff4d4d" }}>⚠️ Important Warnings</h2>
